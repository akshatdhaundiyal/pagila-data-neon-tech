...
* Add event trigger for LOGIN
* Procedure make_payment_data_current is now useful
* Create contrasting generated column examples on film table
* Schema dump file now contains (bogus) restrict key
